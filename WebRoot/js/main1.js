...
newUserNumber = document.getElementById("newUserNumber");
...
var funcSend = function() {
    ...
    //回调函数，进入任务队列等待，返回查询结果，保存在responseText
		...
		xmlhttp.open("GET", "register?reqtype=register&userID=" + newUserNumber.value +
    			"&userName=" + newUserName.value + "&userPasswd=" + newUserPassword.value 
    			+"&userEmail=" + newUserEmail.value , true);
		xmlhttp.send();
...
newUserNumber.onblur = funcDemand;
...
newUserNumber.onfocus = funcClear;
